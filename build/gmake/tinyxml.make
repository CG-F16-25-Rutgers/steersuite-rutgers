...
ifeq ($(config),debug)
  ...
  TARGETDIR  = ../lib
  TARGET     = $(TARGETDIR)/libtinyxml.dylib
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L. -dynamiclib -stdlib=libc++ -Wl,-rpath,/Users/jason_ramirez/Desktop/fall-16-rutgers/computer-graphics/A3/steersuite-rutgers/build/lib -install_name @rpath/libtinyxml.dylib
  LDDEPS    +=
