...
#define MAX_SPEED 2.08f
#define PERFERED_SPEED 1.33 // TODO not added to parameters yet.


#define ACCELERATION 0.537 // = v/A
#define PERSONAL_SPACE_THRESHOLD 0.525 // not defined in HiDAC papaer
#define AGENT_REPULSION_IMPORTANCE 0.509 // in HiDAC
#define QUERY_RADIUS 8.09f // not defined in paper
#define BODY_FORCE 2115.0f // K (big K) 120000 / 80
#define AGENT_BODY_FORCE 2920.0f
#define SLIDING_FRICTION_FORCE 2832.0f // k (small k) 240000 / 80 = 3000
#define AGENT_B 0.238f // inverse proximity force importance
#define AGENT_A 31.31f // 2000 / 80 Yep its just called A... inverse proximity force importance
#define WALL_B 0.733f //  inverse proximity force importance
#define WALL_A 10.0f //  proximity force importance
